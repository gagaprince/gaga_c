...
b.height;return a.x>d&&a.x<e&&a.y>c&&a.y<b?!0:!1}});qc.Sprite.create=function(a,b,c){return new qc.Sprite(a,b,c)};qc.cutRotateImageToCanvas=function(a,b){if(!a)return null;if(!b)return a;var c=qc.newElement("canvas");c.width=b.width;c.height=b.height;var d=c.getContext("2d");d.translate(c.width/2,c.height/2);d.rotate(-1.5707963267948966);d.drawImage(a,b.x,b.y,b.height,b.width,-b.height/2,-b.width/2,b.height,b.width);return c};qc.Label=qc.Sprite.extend({_selfString:"",_fontStyle:"\u9ed1\u4f53",_fontSize:20,_isUpdate:!1,_fillColorStr:"rgba(0,0,0,255)",_displayedOpacity:255,ctor:function(a,b,c){this._super();this._selfString=a;this._fontStyle=b||this._fontStyle;this._fontSize=c||this._fontSize},setString:function(a){this._selfString=a;this._isUpdate=!0},setFontSize:function(a){this._fontSize=a;this._isUpdate=!0},setColor:function(a){this._fillColorStr="rgba("+a.r+","+a.g+","+a.b+","+this._displayedOpacity/255+")";this._isUpdate=
!0},draw:function(a){this._selfString&&""!=this._selfString&&this._updateTexture(a)},_updateTexture:function(a){a.save();0!=this._selfString.length&&(a.font=this._fontSize+"px "+this._fontStyle,a.fillStyle=this._fillColorStr,a.fillText(this._selfString,0,0));a.restore();return!0},setPosition:function(a,b){this._super(a,b);this._isUpdate=!0}});qc.Label.create=function(a,b,c){return new qc.Label(a,b,c)};qc.SpriteFrame=qc.Class.extend({_rect:null,_texture:null,_rotated:!1,ctor:function(){},initWithTexture:function(a,b,c){this._rect=b;this._texture=this.texture=a;this._rotated=c||!1;return!0},initWithFile:function(a,b){qc.assert(a,"\u628a\u6587\u4ef6\u540d\u4f20\u8fdb\u6765\u554a");var c=qc.textureCache.textureForKey(a);if(c){if(!b){var d=c.getContentSize();b=qc.rect(0,0,d.width,d.height)}return this.initWithTexture(c,b)}c=qc.textureCache.addImage(a);return this.initWithTexture(c,b||qc.rect(0,0,c._contentSize.width,
...
setOriginalTarget:function(a){this.originalTarget=a},getTag:function(){return this.tag},setTag:function(a){this.tag=a}});qc.HashElement=qc.Class.extend({actions:null,target:null,actionIndex:0,currentAction:null,currentActionSalvaged:!1,paused:!1,hh:null,ctor:function(){this.actions=[];this.target=null;this.actionIndex=0;this.currentAction=null;this.paused=this.currentActionSalvaged=!1;this.hh=null}});
