var qc=qc||{},ClassManager={id:0|998*Math.random(),instanceId:0|998*Math.random(),compileSuper:function(a,b,c){a=a.toString();var d=a.indexOf("("),e=a.indexOf(")"),d=a.substring(d+1,e),d=d.trim(),e=a.indexOf("{"),f=a.lastIndexOf("}");for(a=a.substring(e+1,f);-1!=a.indexOf("this._super");){var e=a.indexOf("this._super"),f=a.indexOf("(",e),g=a.indexOf(")",f),g=a.substring(f+1,g),g=(g=g.trim())?",":"";a=a.substring(0,e)+"ClassManager["+c+"]."+b+".call(this"+g+a.substring(f+1)}return Function(d,a)},getNewID:function(){return this.id++},
...
qc.Director._getInstance=function(){qc.Director.firstUseDirector&&(qc.Director.firstUseDirector=!1,qc.Director.sharedDirector=new qc.Director,qc.Director.sharedDirector.init());return qc.Director.sharedDirector};qc=qc||{};qc._loadingImage="";qc.newElement=function(a){return document.createElement(a)};qc._addEventListener=function(a,b,c,d){a.addEventListener(b,c,d)};qc.each=function(a,b,c){if(a)if(a instanceof Array)for(var d=0,e=a.length;d<e&&!1!==b.call(c,a[d],d);d++);else for(d in a)if(!1===b.call(c,a[d],d))break};qc.isCrossOrigin=function(a){if(!a)return qc.log("invalid URL"),!1;var b=a.indexOf("://");if(-1==b)return!1;b=a.indexOf("/",b+3);return(-1==b?a:a.substring(0,b))!=location.origin};
...
loadJson:function(a,b){this.loadTxt(a,function(c,d){try{c?b(c):b(null,JSON.parse(d))}catch(e){throw"load json ["+a+"] failed : "+e;}})},_checkIsImageURL:function(a){return null!=/(\.png)|(\.jpg)|(\.bmp)|(\.jpeg)|(\.gif)/.exec(a)},loadImg:function(a,b,c){var d=!0;void 0!==c?d=null==b.isCrossOrigin?d:b.isCrossOrigin:void 0!==b&&(c=b);var e=new Image;d&&"file://"!=location.origin&&(e.crossOrigin="Anonymous");qc._addEventListener(e,"load",function(){this.removeEventListener("load",arguments.callee,!1);
this.removeEventListener("error",arguments.callee,!1);c&&c(null,e)});qc._addEventListener(e,"error",function(){this.removeEventListener("error",arguments.callee,!1);c&&c("load image failed")});e.src=a;return e},_loadResIterator:function(a,b,c){var d=this,e=null,f=a.type;f?(f="."+f.toLowerCase(),e=a.src?a.src:a.name+f):(e=a,f=qc.path.extname(e));if(b=d.cache[e])return c(null,b);b=d._register[f.toLowerCase()];if(!b)return qc.error("loader for ["+f+"] not exists!"),c();f=b.getBasePath?b.getBasePath():
d.resPath;f=d.getUrl(f,e);b.load(f,e,a,function(a,b){a?(qc.log(a),d.cache[e]=null,delete d.cache[e],c()):(d.cache[e]=b,c(null,b))})},getUrl:function(a,b){var c=this._langPathCache,d=qc.path;if(void 0!==a&&void 0===b){b=a;var e=d.extname(b),e=e?e.toLowerCase():"";a=(e=this._register[e])?e.getBasePath?e.getBasePath():this.resPath:this.resPath}b=qc.path.join(a||"",b);if(b.match(/[\/(\\\\)]lang[\/(\\\\)]/i)){if(c[b])return c[b];d=d.extname(b)||"";b=c[b]=b.substring(0,b.length-d.length)+"_"+qc.sys.language+
d}return b},load:function(a,b,c){if(void 0!==c)"function"==typeof b&&(b={trigger:b});else if(void 0!==b)"function"==typeof b&&(c=b,b={});else if(void 0!==a)b={};else throw"arguments error!";b.cb=function(a,b){a&&qc.log(a);c&&c(b)};a instanceof Array||(a=[a]);b.iterator=this._loadResIterator;b.iteratorTarget=this;qc.async.map(a,b)},_handleAliases:function(a,b){var c=this._aliases,d=[],e;for(e in a){var f=a[e];c[e]=f;d.push(f)}this.load(d,b)},loadAliases:function(a,b){var c=this,d=c.getRes(a);d?c._handleAliases(d.filenames,
...
qc.p=function(a,b){return void 0==a?{x:0,y:0}:void 0==b?{x:a.x,y:a.y}:{x:a,y:b}};qc.size=function(a,b){return void 0===a?{width:0,height:0}:void 0===b?{width:a.width,height:a.height}:{width:a,height:b}};qc.rect=function(a,b,c,d){return void 0===a?{x:0,y:0,width:0,height:0}:void 0===b?{x:a.x,y:a.y,width:a.width,height:a.height}:{x:a,y:b,width:c,height:d}};qc._formatString=function(a){if("object"===typeof a)try{return JSON.stringify(a)}catch(b){return""}else return a};
qc.assert=function(a,b){if(!a&&b)throw b;};qc.log=function(a){for(var b=1;b<arguments.length;b++)a=a.replace(/(%s)|(%d)/,qc._formatString(arguments[b]));console.log(a)};qc.warn=console.warn?function(a){for(var b=1;b<arguments.length;b++)a=a.replace(/(%s)|(%d)/,qc._formatString(arguments[b]));console.warn(a)}:qc.log;qc.error=console.error?function(a){for(var b=1;b<arguments.length;b++)a=a.replace(/(%s)|(%d)/,qc._formatString(arguments[b]));console.error(a)}:qc.log;
...
qc._setup=function(a,b,c){if(!qc._setupCalled){qc._setupCalled=!0;var d=window;d.requestAnimFrame=d.requestAnimationFrame||d.webkitRequestAnimationFrame||d.mozRequestAnimationFrame||d.oRequestAnimationFrame||d.msRequestAnimationFrame;var e=qc.$(a)||qc.$("#"+a),f;"CANVAS"==e.tagName?(b=b||e.width,c=c||e.height,d=qc.container=qc.newElement("DIV"),a=qc._canvas=e,a.parentNode.insertBefore(d,a),a.appendTo(d),d.setAttribute("id","QCGameContainer")):("DIV"!=e.tagName&&qc.log("Warning: target element is not a DIV or CANVAS"),
b=b||e.clientWidth,c=c||e.clientHeight,d=qc.container=e,a=qc._canvas=qc.$(qc.newElement("CANVAS")),e.appendChild(a));a.addClass("gameCanvas");a.setAttribute("width",b||480);a.setAttribute("height",c||320);a.setAttribute("tabindex",99);a.style.outline="none";e=a.style;e.width="100%";e.height="100%";f=d.style;f.width=(b||480)+"px";f.height=(c||320)+"px";f.margin="0 auto";f.position="relative";f.overflow="hidden";d.top="100%";qc._renderContext=a.getContext("2d");qc._mainRenderContextBackup=qc._renderContext;
qc._renderContext.translate(0,a.height);qc._gameDiv=d;qc.sys.isMobile&&(a=qc.newElement("style"),a.type="text/css",document.body.appendChild(a),a.textContent="body,canvas,div{ -moz-user-select: none;-webkit-user-select: none;-ms-user-select: none;-khtml-user-select: none;-webkit-tap-highlight-color:rgba(0,0,0,0);}");a=function(){var a=window.innerWidth,d=window.innerHeight;b/c>a/d?(d=a,a=a/b*c):(a=d,d=d/c*b);f.width=(d||480)+"px";f.height=(a||320)+"px"};a();window.addEventListener("resize",a,!1);
qc.EventManager.registerSystemEvent(qc._canvas);qc.director=qc.Director._getInstance();qc.winSize=qc.director.getWinSize();qc.log(qc.winSize)}};
...
!0:!1}});qc.EventListener.TOUCH_ONE_BY_ONE=0;qc.EventListener.create=function(a){var b=new qc._EventListenerTouchOneByOne,c;for(c in a)b[c]=a[c];return b};qc.EventManager={_listeners:[],_isEnabled:!0,addListener:function(a,b){if(!(a instanceof qc.EventListener))a=qc.EventListener.create(a);else if(a._isRegistered())return;a.checkAvailable()&&("number"!=typeof b&&(a._setPaused(!1),a.setEnabled(!0),a._setRegistered(!0),a._setSceneGraphPriority(b)),this._listeners.push(a))},removeListener:function(a){if(null!=a)for(var b=this._listeners,c=b.length,d=0;d<c;d++)if(a==b[d]){b.splice(d,1);break}},dispatchEvent:function(a){if(this._isEnabled){if(!a||!a.getType)throw"event is undefined";
a.getType()==qc.Event.TOUCH&&this._dispatchTouchEvent(a)}},_dispatchTouchEvent:function(a){var b=this._listeners,c=a.getTouches(),d={event:a,touches:c,selTouch:null};if(b)for(var e=0;e<c.length&&(d.selTouch=c[e],this._dispatchEventToListeners(b,this._onTouchEventCallback,d),!a.isStopped());e++);},_dispatchEventToListeners:function(a,b,c){for(var d=a.length,e=0;e<d;e++){var f=a[e];if(f.isEnabled()&&!f._isPaused()&&f._isRegistered()&&b(f,c))break}},_onTouchEventCallback:function(a,b){if(!a._isRegistered)return!1;
var c=b.event,d=b.selTouch;c._setCurrentTarget(a._node);var e=c.getEventCode(),f=qc.EventTouch.EventCode;if(e==f.BEGAN){if(a.onTouchBegan)a.onTouchBegan(d,c)}else if(e===f.MOVED&&a.onTouchMoved)a.onTouchMoved(d,c);else if(e===f.ENDED&&a.onTouchEnded)a.onTouchEnded(d,c);return c.isStopped()?!0:!1},handleTouchesBegin:function(a){a=new qc.EventTouch(a);a._eventCode=qc.EventTouch.EventCode.BEGAN;this.dispatchEvent(a)},handleTouchesEnd:function(a){0<a.length&&(a=new qc.EventTouch(a),a._eventCode=qc.EventTouch.EventCode.ENDED,
this.dispatchEvent(a))},handleTouchesMove:function(a){0<a.length&&(a=new qc.EventTouch(a),a._eventCode=qc.EventTouch.EventCode.MOVED,this.dispatchEvent(a))},getHTMLElementPosition:function(a){var b=document.documentElement,c=window,d=null,d="function"===typeof a.getBoundingClientRect?a.getBoundingClientRect():a instanceof HTMLCanvasElement?{left:0,top:0,width:a.width,height:a.height}:{left:0,top:0,width:parseInt(a.style.width),height:parseInt(a.style.height)};return{left:d.left+c.pageXOffset-b.clientLeft,
top:d.top+c.pageYOffset-b.clientTop,width:d.width,height:d.height}},getPointByEvent:function(a,b){if(null!=a.pageX)return{x:a.pageX,y:a.pageY};b.left-=document.body.scrollLeft;b.top-=document.body.scrollTop;return{x:a.clientX,y:a.clientY}},getTouchByXY:function(a,b,c){a=this.convertToLocationInView(a,b,c);return new qc.Touch(a.x,a.y)},convertToLocationInView:function(a,b,c){var d=qc.director.getWinSize(),e=c.height;return{x:(a-c.left)/c.width*d.width,y:(c.top+e-b)/e*d.height}},registerSystemEvent:function(a){var b=
this,c="touches"in qc.sys.capabilities;"mouse"in qc.sys.capabilities&&(qc._addEventListener(a,"mousedown",function(d){b._mousePressed=!0;var e=b.getHTMLElementPosition(a),f=b.getPointByEvent(d,e);c||b.handleTouchesBegin([b.getTouchByXY(f.x,f.y,e)]);d.stopPropagation();d.preventDefault();a.focus()},!1),qc._addEventListener(a,"mouseup",function(d){b._mousePressed=!1;var e=b.getHTMLElementPosition(a),f=b.getPointByEvent(d,e);c||b.handleTouchesEnd([b.getTouchByXY(f.x,f.y,e)]);d.stopPropagation();d.preventDefault()},
!1),qc._addEventListener(a,"mousemove",function(d){var e=b.getHTMLElementPosition(a),f=b.getPointByEvent(d,e);!c&&b._mousePressed&&b.handleTouchesMove([b.getTouchByXY(f.x,f.y,e)]);d.stopPropagation();d.preventDefault()},!1));c&&(qc._addEventListener(a,"touchstart",function(c){if(c.changedTouches){var e=b.getHTMLElementPosition(a);e.left-=document.body.scrollLeft;e.top-=document.body.scrollTop;b.handleTouchesBegin(b.getTouchesByEvent(c,e));c.stopPropagation();c.preventDefault();a.focus()}},!1),qc._addEventListener(a,
"touchmove",function(c){if(c.changedTouches){var e=b.getHTMLElementPosition(a);e.left-=document.body.scrollLeft;e.top-=document.body.scrollTop;b.handleTouchesMove(b.getTouchesByEvent(c,e));c.stopPropagation();c.preventDefault()}},!1),qc._addEventListener(a,"touchend",function(c){if(c.changedTouches){var e=b.getHTMLElementPosition(a);e.left-=document.body.scrollLeft;e.top-=document.body.scrollTop;b.handleTouchesEnd(b.getTouchesByEvent(c,e));c.stopPropagation();c.preventDefault()}},!1))},removeListeners:function(a){a=
a.__instanceId;for(var b=this._listeners,c=0;c<b.length;c++){var d=b[c];d._node.__instanceId!=a&&(d.setEnabled(!1),d._setRegistered(!1),b.splice(c,1),c--)}},isChildOfParent:function(a,b){if(null==a)return!1;if(a.__instanceId!=b)return this.isChildOfParent(a.getParent(),b)},getTouchesByEvent:function(a,b){for(var c=[],d,e=a.changedTouches.length,f=0;f<e;f++)if(d=a.changedTouches[f]){var g;g=qc.sys.BROWSER_TYPE_FIREFOX===qc.sys.browserType?this.convertToLocationInView(d.pageX,d.pageY,b):this.convertToLocationInView(d.clientX,
d.clientY,b);d=null!=d.identifier?new qc.Touch(g.x,g.y,d.identifier):new qc.Touch(g.x,g.y);c.push(d)}return c}};qc.Action=qc.Class.extend({originalTarget:null,target:null,tag:1,_duration:null,ctor:function(){this.target=this.originalTarget=null;this.tag=qc.ACTION_TAG_INVALID},isDone:function(){return!0},startWithTarget:function(a){this.target=this.originalTarget=a},stop:function(){this.target=null},step:function(a){qc.log("[Action step]. override me")},update:function(a){qc.log("[Action update]. override me")},getTarget:function(){return this.target},setTarget:function(a){this.target=a},getOriginalTarget:function(){return this.originalTarget},
...
c+this.speedY*a;this.timesum>=this._duration&&(this._isDone=!0,b=this._desScaleX,a=this._desScaleY);this.target.setScale(b,a)},isDone:function(){return this._isDone}});qc.ScaleTo.create=function(a,b){return new qc.ScaleTo(a,b)};qc.HashElement=qc.Class.extend({actions:null,target:null,actionIndex:0,currentAction:null,currentActionSalvaged:!1,paused:!1,hh:null,ctor:function(){this.actions=[];this.target=null;this.actionIndex=0;this.currentAction=null;this.paused=this.currentActionSalvaged=!1;this.hh=null}});
...
this._actions[0].startWithTarget(a);this.hasStartAction2=this._isDone=!1},step:function(a){var b=this._actions[0];if(this.hasStartAction2){var c=this._actions[1];c.step(a);c.isDone()&&(this._isDone=!0)}else b.step(a),b.isDone()&&(c=this._actions[1],this.hasStartAction2||(c.startWithTarget(this.target),b.stop(),this.hasStartAction2=!0))},isDone:function(){return this._isDone}});qc.Sequence._actionOneTwo=function(a,b){var c=new qc.Sequence;c.initWithTwoActions(a,b);return c};qc.Sequence.create=function(a){return new qc.Sequence(a)};var res={mapbg1:"res/images/map_bg0.png",roleimg:"res/images/role_big0.png",startmenu:"res/images/menu0.png",startmenuplist:"res/plist/menu0.plist",startui:"res/images/ui0.png",startuiplist:"res/plist/ui0.plist",petnum:"res/images/pet_num.png",bullet_lv:"res/images/bullet_lv.png",bullet_lv_plist:"res/plist/bullet_lv.plist",cj_plist:"res/plist/cj.plist",cjimg:"res/images/cj.png",spimg:"res/images/sp_all.png",spplist:"res/plist/sp_all.plist",font_m:"res/images/game_m.png",num_ji:"res/images/num_x0.png",
num_ji0:"res/images/num_jl0.png",daojuimg:"res/images/add_image.png",daoju_plist:"res/plist/add_image.plist",pauseimg:"res/images/pause_all.png",pause_plist:"res/plist/pause_all.plist",effectimg:"res/images/effect0.png",effectplist:"res/plist/effect0.plist",effect2img:"res/images/cc_efx.png",effect2plist:"res/plist/cc_efx.plist",cjuiimg:"res/images/ui_ts.png",cjuiplist:"res/plist/ui_ts.plist"},start_resources=[res.daojuimg,res.daoju_plist],shop_resources=[res.bullet_lv,res.bullet_lv_plist],cj_resources=
[res.cj_plist,res.cjimg],game_resources=[res.bullet_lv_plist,res.bullet_lv,res.spplist,res.spimg,res.daoju_plist,res.daojuimg,res.pause_plist,res.pauseimg,res.effectplist,res.effectimg,res.effect2plist,res.effect2img],gameover_resources=[res.cjuiplist,res.cjuiimg],g_resources=[res.mapbg1,res.roleimg,res.startmenu,res.startui,res.petnum,res.bullet_lv,res.cjimg,res.spimg,res.num_ji,res.num_ji0,res.font_m,res.daojuimg,res.pauseimg,res.effectimg,res.effect2img,res.cjuiimg,res.startmenuplist,res.startuiplist,
res.bullet_lv_plist,res.cj_plist,res.spplist,res.daoju_plist,res.pause_plist,res.effectplist,res.effect2plist,res.cjuiplist];var LoaderScene=qc.Scene.extend({_interval:null,_length:0,_count:0,_label:null,_className:"LoaderScene",init:function(){return!0},_initStage:function(a,b){var c=this._texture2d=new qc.Texture2D;c.initWithElement(a);c.handleLoadedTexture();c=this._logo=qc.Sprite.create(c);c.setScale(qc.contentScaleFactor());c.x=b.x;c.y=b.y;this._bgLayer.addChild(c,10)},onEnter:function(){qc.Node.prototype.onEnter.call(this);this._startLoading()},onExit:function(){qc.Node.prototype.onExit.call(this)},initWithResources:function(a,
b){"string"==typeof a&&(a=[a]);this.resources=a||[];this.cb=b},_startLoading:function(){var a=this,b=a.resources;a._length=b.length;a._count=0;qc.loader.load(b,function(b,d){a._count=d},function(){a.cb&&a.cb()})},_updatePercent:function(){var a=this._count/this._length*100|0,a=Math.min(a,100);qc.log(a)}});LoaderScene.preload=function(a,b){this.loaderScene||(this.loaderScene=new LoaderScene,this.loaderScene.init());this.loaderScene.initWithResources(a,b);qc.director.runScene(this.loaderScene);return this.loaderScene};var TestLayer=qc.Layer.extend({mysprite:null,isSelect:!1,init:function(){this._super();this.setPosition(0,0);var a=qc.Sprite.create(res.daojuimg,qc.rect(0,0,64,86));this.addChild(a);var b=qc.director.getWinSize();a.setPosition(qc.p(b.width/2,b.height/2));a.setRotation(90);a.setAnchorPoint(qc.p(0.5,0.5));var c=qc.Sprite.create(res.daojuimg,qc.rect(0,0,64,43));this.addChild(c);var d=qc.MoveTo.create(0.5,qc.p(240,320)),e=qc.MoveTo.create(0.5,qc.p(b.width/2,b.height/2)),f=qc.RotateTo.create(1,360),g=
qc.CallFunc.create(function(){a.setRotation(0)},this),h=qc.ScaleTo.create(0.5,2),l=qc.ScaleTo.create(0.5,1),d=qc.Sequence.create([d,e,f,g,h,l]),d=qc.RepeatForever.create(d);a.runAction(d);setTimeout(function(){a.stopAllActions();a.setLocalZOrder(100)},2E3);c.setPosition(qc.p(b.width/2,b.height/2));this.mysprite=c;this.addListener();c=qc.SpriteFrameCache._getInstance();c.addSpriteFrames(res.daoju_plist,res.daojuimg);d=c.getSpriteFrame("game_skill_k.png");b=qc.Sprite.create(d);b.setPosition(qc.p(30,
30));e=[];e.push(d);e.push(c.getSpriteFrame("game_skill_0.png"));e.push(c.getSpriteFrame("game_skill_1.png"));c=qc.Animation.create(e,0.1);c=qc.Animate.create(c);b.runAction(c);this.addChild(b)},addListener:function(){qc.EventManager.addListener({event:qc.EventListener.TOUCH_ONE_BY_ONE,swallowTouches:!0,onTouchBegan:this.onTouchBegan.bind(this),onTouchMoved:this.onTouchMoved.bind(this),onTouchEnded:this.onTouchEnded.bind(this)},this)},onTouchBegan:function(a,b){var c=a.getLocation();qc.log(c);var d=
this.mysprite.getDrawRect(),e=this.mysprite.getPosition(),f=e.x+d.x,g=f+d.width,e=e.y+d.y,d=e+d.height;c.x>f&&c.x<g&&c.y>e&&c.y<d&&(this.isSelect=!0)},onTouchMoved:function(a,b){if(this.isSelect){var c=a.getLocation();qc.log(c);this.mysprite.setPosition(c)}},onTouchEnded:function(a,b){this.isSelect=!1}}),MyScene=qc.Scene.extend({onEnter:function(){this._super();var a=new TestLayer;a.init();this.addChild(a)}});qc.game.onStart=function(){LoaderScene.preload(start_resources,function(){var a=new MyScene;qc.director.runScene(a)})};qc.game.run();