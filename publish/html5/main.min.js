...
var a=qc.Label.create("\u4e3e\u724c\u5c0f\u4eba","\u5fae\u8f6f\u96c5\u9ed1","bold 40");a.setColor(qc.color(255,51,204));a.setPosition(qc.p(-80,300));this.bgLayer.addChild(a)},initPeople:function(){this.peopleLayer=ShowLayer.create();this.addChild(this.peopleLayer);this.peopleLayer.setScale(0.75);this.peopleLayer.setPosition(this.midpos)},initListener:function(){var a=this;$("#inText").on("input",function(){var b=$(this).val();a.peopleLayer.add(b)})}}),UpScene=qc.Scene.extend({onEnter:function(){this._super();
var a=new UpLayer;a.init();this.addChild(a)}});qc.game.onStart=function(){LoaderScene.preload(start_resources,function(){var a=new UpScene;qc.director.runScene(a)})};qc.game.run();